        ...
        <div className="screen splash">
          <div className="card menu-card">
            ...
            <p>
              ...
              Thomas Koenders, &ldquo;Gerald Ford Aircraft Carrier&rdquo; by Uxman, &ldquo;F-16 Fighter Jet&rdquo; by iedalton, &ldquo;Jungle Tent&rdquo; by SyntheticMN, &ldquo;Patrol Boat PBR MK2&rdquo; by Savy, &ldquo;Hellfire Missile&rdquo; by xephoney &ldquo;Spike LR2 anti-tank anti-personnel rocket&rdquo; by s_ebo_l and &ldquo;Missiles&rdquo; by Civorsky. Where a model is
            ...
            <p>Music: &ldquo;Iron Sector Run&rdquo;, &ldquo;Jungle Advance&rdquo;, &ldquo;Arctic Front&rdquo;, &ldquo;March of the Sands&rdquo;, &ldquo;Salt Air Stance&rdquo; and &ldquo;Swamp March&rdquo;, generated with Suno. The rotor is a recording by freesound_community via Pixabay; other sound effects are synthesised in the browser with the Web Audio API. Title artwork, logo and mission key art generated with Nano Banana Pro; app icon generated with Nano Banana Pro via Higgsfield.</p>
