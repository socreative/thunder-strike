      ...
      return (
        <div className="screen splash">
          <div className="card menu-card">
            ...
            <p>
              Vehicle models: &ldquo;Low Poly Military Vehicles&rdquo; by Zsky, licensed CC-BY 4.0 via Poly Pizza. Additional models by Quaternius (CC0). The carrier is &ldquo;Gerald Ford Aircraft
              Carrier&rdquo; by Uxman, CC-BY 4.0 via Sketchfab. Where a model is missing the game builds a procedural placeholder instead.
            </p>
