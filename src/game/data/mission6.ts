...
export const mission6: MissionData = {
  ...
  briefing: [
    ...
    "The dead come up out of three concrete crypts in the old burial mounds, and they keep coming while a crypt stands. Burn all three. They also come up out of the water itself: where the mist lies thick on a pool and the surface starts to boil, one is on its way up. They are slow and they cannot fly, but they will wade, and they will climb anything that hangs still over them. Stay moving and they are harmless. Slow down to winch and they are on the skids.",
