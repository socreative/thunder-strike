...
export class Audio {
  ...
  private loopLength(track: string, buf: AudioBuffer): number {
    ...
    const trims: Record<string, number> = { "iron-sector-run": 57.17, "jungle-advance": 86.66, "arctic-front": 188.23, "march-of-the-sands": 86.43, "salt-air-stance": 136.695, "swamp-march": 173.405 };
